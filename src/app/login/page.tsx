      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">
            Sign in to manage your bookings, profile or technician requests
          </p>
        </div>

        {/* Demo Quick-Fill Pill Bar */}
        <div className="mb-6 bg-slate-50 border border-slate-200/80 rounded-2xl p-3.5">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="flex flex-col items-center p-2 rounded-xl bg-white border border-slate-200 text-slate-700 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50/50 transition-all text-xs font-medium cursor-pointer shadow-2xs"
            >
            ...
            <button
              ...
              className="flex flex-col items-center p-2 rounded-xl bg-white border border-slate-200 text-slate-700 hover:border-teal-500 hover:text-teal-600 hover:bg-teal-50/50 transition-all text-xs font-medium cursor-pointer shadow-2xs"
            >
            ...
            <button
              ...
              className="flex flex-col items-center p-2 rounded-xl bg-white border border-slate-200 text-slate-700 hover:border-purple-500 hover:text-purple-600 hover:bg-purple-50/50 transition-all text-xs font-medium cursor-pointer shadow-2xs"
            >
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center space-y-3">
            ...
            <div className="inline-block">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-teal-700 bg-teal-50 hover:bg-teal-100 px-3 py-1.5 rounded-lg border border-teal-200 transition-colors"
              >
                <Briefcase className="w-3.5 h-3.5" /> Join as a Technician
              </Link>
            </div>
          </div>
        </div>
