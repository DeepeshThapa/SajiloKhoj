    ...
    <div className="min-h-screen bg-slate-50 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          >
            <ArrowLeft className="w-4 h-4" /> Back to all technicians
          </Link>
          <span className="text-xs text-slate-400">
            Technician ID: <span className="font-mono">{tech.id.slice(-8)}</span>
          </span>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 overflow-hidden shadow-xs mb-8">
          {/* Cover Photo */}
          <div className="h-44 sm:h-64 relative bg-slate-800">
            <Image
              src={coverSrc}
              alt={tech.user.name}
              fill
          ...
          <div className="px-6 sm:px-10 pb-8 relative">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 -mt-16 sm:-mt-20">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-5 text-center sm:text-left">
                <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-3xl overflow-hidden bg-white border-4 border-white shadow-xl relative shrink-0">
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-2 flex-wrap">
                    ...
                    {tech.verificationStatus === 'APPROVED' && (
                      <span
                        ...
                        className="inline-flex items-center gap-1 bg-blue-50 text-blue-700 text-xs font-bold px-2.5 py-0.5 rounded-full border border-blue-200/80"
                      >
              ...
              <div className="self-center sm:self-end">
                <span className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-800 bg-emerald-50 border border-emerald-200 px-3.5 py-1.5 rounded-full">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <Briefcase className="w-5 h-5 text-blue-600" /> About Technician
              </h2>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                  <Wrench className="w-5 h-5 text-blue-600" /> Services & Pricing
                </h2>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
              <h2 className="text-lg font-bold text-slate-900 mb-4 flex items-center gap-2">
                <Award className="w-5 h-5 text-teal-600" /> Skills & CTEVT Credentials
              </h2>
              ...
              {tech.certifications && (
                <div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 flex items-center gap-2.5">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                    <MessageSquare className="w-5 h-5 text-blue-600" /> Customer Reviews ({tech.reviews.length})
                  </h2>
                ...
                <div className="text-right">
                  <span className="text-2xl font-black text-slate-900">{tech.rating.toFixed(1)}</span>
              ...
              <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-4 text-xs">
                ...
                <div className="space-y-2 text-slate-600">
                  <div className="flex justify-between py-1 border-b border-slate-100">
                    ...
                    <span className="font-bold text-slate-800">{tech.province}</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-slate-100">
                    <span className="text-slate-400 font-medium">District</span>
                    <span className="font-bold text-slate-800">{tech.district}</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-slate-100">
                  ...
                  {tech.locality && (
                    <div className="flex justify-between py-1 border-b border-slate-100">
                      ...
                      <span className="font-bold text-slate-800">{tech.locality}</span>
                    </div>
                  )}
