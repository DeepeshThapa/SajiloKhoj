      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">
            Book verified plumbers, electricians, and home experts in Nepal
          </p>
        </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center space-y-3">
            ...
            <div className="pt-2">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-teal-700 bg-teal-50 hover:bg-teal-100 px-3.5 py-2 rounded-xl border border-teal-200 transition-colors w-full justify-center"
              >
                <Briefcase className="w-4 h-4" /> Are you a service professional? Register as Technician
              </Link>
            </div>
          </div>
        </div>
